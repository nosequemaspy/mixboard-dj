...
export function MixerPanel() {
  ...
  return (
    <div className="w-[200px] bg-bg-secondary border-x border-border hidden lg:flex flex-col items-center py-3 px-2 gap-3 flex-shrink-0">
      ...
      <div className="flex gap-6 items-stretch flex-1 w-full justify-center min-h-0 max-h-[200px] pb-5">
        ...
        <div className="flex flex-col items-center gap-1.5">
          <span className="text-[9px] text-text-muted tracking-wide">VOL B</span>
          <div className="flex gap-2 flex-1 min-h-0 items-stretch">
            <VerticalFader
